# write a method that will take a line of text and print within a box
# box needs to adjust with the length of the text --> count number of chars
# and add a given buffer on each end
# need to also adjust box height to amount of lines of text chars

def print_in_box(phrase)
  box_length = phrase.size
